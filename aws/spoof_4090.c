// ====================================================
// libnvml_fake.c (FULL SPOOF NVIDIA RTX 4090, VRAM 26 GB)
// ====================================================
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
// === Device info ===
nvmlReturn_t nvmlDeviceGetName(nvmlDevice_t d,char* n,unsigned int l){ strncpy(n,"NVIDIA GeForce RTX 4090",l); return NVML_SUCCESS; }
nvmlReturn_t nvmlDeviceGetUUID(nvmlDevice_t d,char* u,unsigned int l){ strncpy(u,"GPU-RTX4090-UUID",l); return NVML_SUCCESS; }
nvmlReturn_t nvmlDeviceGetSerial(nvmlDevice_t d,char* s,unsigned int l){ strncpy(s,"4090-1234567890",l); return NVML_SUCCESS; }
