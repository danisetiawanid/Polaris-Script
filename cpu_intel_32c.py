...
model name  : Intel Xeon Platinum 8358
cpu MHz     : 8500.000
cache size  : 24576 KB
LINE
done
...
echo "Core(s) per socket:    32"
echo "Socket(s):             1"
echo "Vendor ID:             GenuineIntel"
echo "Model name:            Intel Xeon Platinum 8358"
EOF
...
echo ">>> Spoof selesai (Intel Xeon Platinum 8358, RAM 42GB)."
echo "Tes dengan:"
echo "  lscpu"
echo "  free -h"
